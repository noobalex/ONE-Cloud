...
import com.wuxianmali.one.gateway.fallback.OneGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class OneGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new OneGatewayBlockFallbackProvider());
        initGatewayRules();
    }
